...
- **Reclassification note (added 2026-08-02):** This campaign is reclassified as **Historical Baseline**, not a framework-compliance failure. Verified directly from Meta: the ad set and ad in this experiment were created 2026-08-01T09:38 UTC — roughly 12.5 hours before `docs/historical-analysis.md` "Historical Pattern Discovery v1" (the source of HYP-001/002/003/005) was published at 2026-08-01T22:06 UTC (v1.3). A same-day full audit initially described this campaign's manually-restricted placements, gender/age-narrowed audience, and dark-built creative as "deviations" from the framework — that framing was retrospective bias and has been corrected per [`docs/evidence-rules.md`](evidence-rules.md) Rule 10. These same settings are legitimate historical evidence: this campaign's audience/placement/creative choices are exactly the kind of pre-framework account behavior that HYP-001, HYP-002, HYP-003, and HYP-005 were built to test against, not a violation of hypotheses that didn't exist yet when it launched.
