...
5. **Don't judge a creative that hasn't cleared Discovery-stage spend** (see `docs/framework.md`) — a single day or a single sale (as with Canton 3's current Tunic test, one EGP5.89 purchase so far) is not evidence of anything yet.
